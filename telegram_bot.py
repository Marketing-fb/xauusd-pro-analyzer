...
class TelegramBotHandler:
    """
    Interactive Telegram Command Bot Handler:
    Commands:
    /start or /help - คำสั่งเริ่มต้นและวิธีใช้งาน
    /signal - ดึงสัญญาณ AI Signal, Optimal Entry (OTE), SL, TP1, TP2, TP3
    /news - ดึงรายงานข่าวเศรษฐกิจ USD & Gold คืนนี้
    /risk balance risk_pct sl_pips - คำนวณ Lot Size & Risk
    /status - ดึงสถิติ AI Win Rate % และผลการเรียนรู้ล่าสุด
    """
